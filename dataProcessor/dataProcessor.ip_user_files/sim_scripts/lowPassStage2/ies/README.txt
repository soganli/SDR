...
#
# Generated by export_simulation on Sun Dec 18 18:12:28 +03 2022
#
################################################################################
...
'-reset_run' switch to the './lowPassStage2.sh' script.

./lowPassStage2.sh -reset_run
...
./lowPassStage2.sh -noclean_files

For more information on the script, please type './lowPassStage2.sh -help'.
