...
#
# Generated by export_simulation on Tue Dec 20 02:09:07 +03 2022
#
################################################################################
...
'-reset_run' switch to the './lowPassStage1.sh' script.

./lowPassStage1.sh -reset_run
...
./lowPassStage1.sh -noclean_files

For more information on the script, please type './lowPassStage1.sh -help'.
